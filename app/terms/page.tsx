      ...
      <section className="mx-auto max-w-5xl">
        ...
        <header className="mt-10 max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-emerald-100">
            Herbal Care предоставя образователна информация за билки, симптоми, природна грижа и
            предпазни мерки. Използвайте съдържанието внимателно и като подготовка за разговор със
            специалист.
          </p>
        </header>
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-2">
          <TermsSection title="Само образователна информация">
            Съдържанието в Herbal Care е предназначено за обща ориентация. То не е индивидуален
            медицински съвет и не трябва да се използва като основание за започване, спиране или
            промяна на лечение.
          </TermsSection>

          <TermsSection title="Отговорност на потребителя">
            При симптоми, заболявания, прием на лекарства, бременност, кърмене, алергии или
            хронични състояния потърсете лекар или фармацевт преди употреба на билки или добавки.
          </TermsSection>

          <TermsSection title="AI помощник">
            Отговорите от AI помощника са информационни, може да са непълни или грешни и не
            представляват диагноза, лечение или предписание. Проверявайте важната информация със
            специалист.
          </TermsSection>

          <TermsSection title="Рискове при билки">
            Билките може да имат противопоказания, да предизвикат алергии или да взаимодействат с
            лекарства. Естествен произход не означава автоматично безопасност за всеки човек.
          </TermsSection>
        </section>
